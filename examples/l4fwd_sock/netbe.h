...
typedef uint16_t (*TLE_RX_BULK_FUNCTYPE)(struct tle_dev *dev, struct rte_mbuf *pkt[],
...
typedef uint16_t (*TLE_STREAM_RECV_FUNCTYPE)(struct tle_stream *ts, struct rte_mbuf *pkt[], uint16_t num);
